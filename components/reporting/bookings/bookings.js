                ...
                return [
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    {text: findSymbolForClass('fa-book'), style: 'fontAwesome', fontSize: 20, margin: [0, 8, 0, 30]},
            ...
            content: [
                ...
                },
                {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {text: findSymbolForClass('fa-plane'), style: 'fontAwesome', fontSize: 18, margin: [0, 10, 0, 30]},
                ...
                },
                {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {text: findSymbolForClass('fa-user-circle-o'), style: 'fontAwesome', fontSize: 17, margin: [0, 8, 0, 30]},
                ...
                },
                {
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {text: findSymbolForClass('fa-money'), style: 'fontAwesome', fontSize: 18, margin: [0, 10, 0, 30]},
